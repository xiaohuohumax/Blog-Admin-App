...
const routes = [{
    ...
    children: [{
      ...
      },
      {
        path: 'WebRoleManager',
        name: '用户角色',
        component: allCom.WebRoleManager,
        meta: {
          resources: ["router_webrolemanager"]
        }
      }, {
        ...
        name: '用户资源',
        component: allCom.WebResourceManager,
        meta: {
          resources: ["router_webresourcemanager"]
        }
      }, {
        ...
        path: 'FireWebRoleManager',
        name: '添加/修改用户角色',
        component: allCom.FireWebRoleManager,
        meta: {
          resources: ["router_firewebrolemanager"]
        }
      }, {
      ...
      {
        path: 'FireWebResourceManager',
        name: '创建/管理用户资源',
        component: allCom.FireWebResourceManager,
        meta: {
          resources: ["router_firewebresourcemanager"]
        }
      }, {
        path: 'SongManager',
        name: '歌曲管理',
        ...
        path: 'BaseControl',
        name: '基本操控',
        component: allCom.BaseControl,
        meta: {
          resources: ["router_basecontrol"]
        }
      }, {
        path: '/Error404',
        name: '错误 404',
