<template>
<div class="writeUpdataArticle">
    <Content>
        <template #head>
            <Button type="success" @click="onSubmit">提交</Button>
        </template>

        <input v-model.trim="title" type="text" class="w-100 h3 py-3 border-0" placeholder="请输入标题(30字)" />
        <input v-model.trim="subTitle" type="text" class="w-100 h5 py-3 border-0" placeholder="请输入副标题(100字)" />
